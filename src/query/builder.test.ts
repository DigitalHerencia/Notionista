...
describe('QueryBuilder', () => {
  describe('Basic Filters', () => {
    ...
    it('should create a checkbox filter', () => {
      const query = new QueryBuilder().where('done', 'checkbox', 'equals', false).build();
    ...
    it('should create a number filter', () => {
      const query = new QueryBuilder().where('count', 'number', 'greater_than', 5).build();
    ...
    it('should create a text filter', () => {
      const query = new QueryBuilder().where('name', 'title', 'contains', 'Project').build();
    ...
    it('should create a date filter', () => {
      const query = new QueryBuilder().where('due', 'date', 'after', '2025-01-01').build();
    ...
    it('should handle is_empty operator without value', () => {
      const query = new QueryBuilder().where('description', 'rich_text', 'is_empty').build();
  ...
  describe('Sorting', () => {
    it('should add a property sort', () => {
      const query = new QueryBuilder().orderBy('due', 'ascending').build();
    ...
    it('should add a timestamp sort', () => {
      const query = new QueryBuilder().orderByTimestamp('created_time', 'descending').build();

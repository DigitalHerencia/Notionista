...
export const TeamIds = {
  'Engineering Team':
    _REG.teamDatabases?.engineering?.id ?? '{{registry.teamDatabases.engineering.id}}',
  'Marketing Team': _REG.teamDatabases?.marketing?.id ?? '{{registry.teamDatabases.marketing.id}}',
  'Operations Team':
    _REG.teamDatabases?.operations?.id ?? '{{registry.teamDatabases.operations.id}}',
  'Design Team': _REG.teamDatabases?.design?.id ?? '{{registry.teamDatabases.design.id}}',
  'Research Team': _REG.teamDatabases?.research?.id ?? '{{registry.teamDatabases.research.id}}',
  'Product Team': _REG.teamDatabases?.product?.id ?? '{{registry.teamDatabases.product.id}}',
} as const;
...
export const TeamDatabaseIds = {
  operations: {
    projects:
      _REG.teamDatabases?.operations?.projects?.id ??
      '{{registry.teamDatabases.operations.projects.id}}',
    tasks:
      _REG.teamDatabases?.operations?.tasks?.id ?? '{{registry.teamDatabases.operations.tasks.id}}',
  },
  product: {
    projects:
      _REG.teamDatabases?.product?.projects?.id ?? '{{registry.teamDatabases.product.projects.id}}',
    tasks: _REG.teamDatabases?.product?.tasks?.id ?? '{{registry.teamDatabases.product.tasks.id}}',
  },
  design: {
    projects:
      _REG.teamDatabases?.design?.projects?.id ?? '{{registry.teamDatabases.design.projects.id}}',
    tasks: _REG.teamDatabases?.design?.tasks?.id ?? '{{registry.teamDatabases.design.tasks.id}}',
  },
  engineering: {
    projects:
      _REG.teamDatabases?.engineering?.projects?.id ??
      '{{registry.teamDatabases.engineering.projects.id}}',
    tasks:
      _REG.teamDatabases?.engineering?.tasks?.id ??
      '{{registry.teamDatabases.engineering.tasks.id}}',
  },
  marketing: {
    projects:
      _REG.teamDatabases?.marketing?.projects?.id ??
      '{{registry.teamDatabases.marketing.projects.id}}',
    tasks:
      _REG.teamDatabases?.marketing?.tasks?.id ?? '{{registry.teamDatabases.marketing.tasks.id}}',
  },
  research: {
    courses:
      _REG.teamDatabases?.research?.courses?.id ?? '{{registry.teamDatabases.research.courses.id}}',
    modules:
      _REG.teamDatabases?.research?.modules?.id ?? '{{registry.teamDatabases.research.modules.id}}',
    leetcode:
      _REG.teamDatabases?.research?.leetcode?.id ??
      '{{registry.teamDatabases.research.leetcode.id}}',
  },
} as const;
